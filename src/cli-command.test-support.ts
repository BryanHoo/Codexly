...
export function createHarness(overrides: Partial<CliDependencies> = {}): CliHarness {
  ...
  const stateRepository = {
    ...
    readProjectTodoAttachment: vi.fn(() => Promise.resolve(undefined)),
    readSubmission: vi.fn(() => Promise.resolve(undefined)),
    writeSubmission: vi.fn(() => Promise.resolve()),
  ...
  const dependencies: CliDependencies = {
    ...
    checkCodexVersion: vi.fn(() =>
      Promise.resolve({ raw: "codex-cli 0.155.1", version: "0.155.1" }),
    ),
    ...
    startCodexAppServer: vi.fn(() =>
      Promise.resolve({
        ...
        close,
        pid: 4321,
        version: { raw: "codex-cli 0.155.1", version: "0.155.1" },
        waitForExit: () => exit,
      }),
    ),
