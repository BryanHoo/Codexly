...
请使用 [GitHub 私密漏洞报告](https://github.com/BryanHoo/CodeAgent/security/advisories/new)，不要创建公开 Issue。报告应包含受影响版本、运行平台、复现步骤、影响范围和必要的脱敏证据。
...
- 浏览器只访问 CodeAgent Server 的受控 API，不直接连接 Codex App Server、数据库或本地文件系统。
