...
安全修复只发布到最新版本。报告问题前，请先升级到 npm 或 GitHub Releases 上的最新版本。
...
桌面安装包从本仓库的 GitHub Releases 发布。当前安装包未配置操作系统发行者代码签名；Tauri updater 产物使用独立密钥签名，但不等同于操作系统代码签名。安装前请核对发布标签和工作流记录，勿在公开 Issue 提交漏洞细节或敏感数据。
