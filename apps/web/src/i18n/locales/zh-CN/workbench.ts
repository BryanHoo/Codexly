...
export const workbench = {
  ...
  composer: {
    ...
    applyTodo: "应用待办",
    applyTodoDescription: "应用待办将覆盖输入框中的当前内容。是否继续？",
    applyTodoTitle: "覆盖当前输入？",
    approvalMode: "批准模式",
    ...
    waitingToSend: "等待发送",
    todoCount: "待办 {{count}}",
    todoHasChanges: "有未保存修改",
    todoList: "{{project}} 的待办",
  ...
  sidebar: {
    ...
    createWorktreeTask: "在 {{project}} 中创建 worktree 任务",
    createWorktreeTaskConfirm: "创建 worktree 和任务",
    worktreeTaskDescription: "基于当前检出创建独立 worktree，并在其中开始任务",
    worktreeTaskTitle: "创建 worktree 任务",
