export const settings = {
  about: {
    ...
    progress: {
      backingUp: "Backing up the current version",
      checking: "Confirming the latest version",
      completed: "Update installed",
      downloading: "Downloading the update",
      installing: "Installing the new version",
      label: "Codexly update progress",
      rollingBack: "Installation failed. Restoring the previous version",
    },
