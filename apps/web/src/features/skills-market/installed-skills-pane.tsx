import type { InstalledSkill } from "@codexly/protocol";
  ...
  return (
    <li className="skills-installed-row">
      <button
        ...
        type="button"
      >
        <span aria-hidden="true" className="skills-market-glyph" data-tone="skills">
          <Blocks />
        </span>
    ...
    <div className="skills-market-pane" role="tabpanel">
      <div className="skills-market-toolbar">
        ...
        <Button
          ...
          variant="ghost"
        >
          <RefreshCw aria-hidden="true" className={installed.isFetching ? "animate-spin" : ""} />
        </Button>
      </div>
      {installed.isPending ? (
