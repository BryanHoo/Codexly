...
import { resolveScheduledTaskLocale, toLocalDateTimeInput } from "../scheduled-task-schedule.js";
        ...
        onChange={(date: Date | null) => {
          onChange(
            date === null
              ? ""
              : dateOnly
                ? toLocalDateTimeInput(date.getTime()).slice(0, 10)
                : toLocalDateTimeInput(date.getTime()),
          );
        }}
